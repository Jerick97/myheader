function FiltersHome() {
    return (
      <div className="row my-3">
        ...
        <div className="col-lg-3 col-md-4 col-sm-7 col-7 mb-lg-0 px-0">
        ...
        <div className="col-lg-1 col-md-2 col-sm-2 col-2 m-left-4 mb-md-0 d-flex align-items-center">
          <div className="px-0 py-1">
            <div className="btn-group">
              <button
                ...
                aria-expanded="false"
              >
                <i className="fa-solid fa-filter mx-md-1 mx-sm-2"></i>
        ...
        <div className="col-lg-1 col-md-2 col-sm-2 col-2 m-left-4 d-flex mx-auto">
          <div className="px-0 py-1">
            <div className="btn-group">
              <button className="btn btn-md btn-fill-primary btn-primary d-flex align-items-center" type="button">
                <i className="fa-solid fa-file-export mx-md-1 mx-sm-2 py-1"></i><span className="d-none d-md-block fs-6">Exportar</span>
              </button>
            </div>
          </div>
        </div>
